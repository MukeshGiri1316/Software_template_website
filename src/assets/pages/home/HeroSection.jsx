...
function HeroSection() {
    ...
    return (
        <div className='relative min-h-[70vh] md:min-h-[100vh] grid grid-cols-1 md:grid-cols-2 bg-gradient-to-b md:bg-gradient-to-r from-primary/40 to-transparent pt-10 overflow-hidden'>
            ...
            <div className='z-20 flex flex-col justify-center items-center'>
                <div className='p-15 flex flex-col gap-5'>
                    ...
                    <div className='text-lg md:text-2xl lg:text-4xl font-bold text-primaryText'><span className='text-secondaryText tracking-wider capitalize'>{typeEffect}<Cursor /></span> Development</div>
            ...
            <div className='z-20 flex justify-center items-center'>
                <img src="/images/top-banner.png" alt="top-banner" className='w-[300px] md:w-2/3 drop-shadow-2xl' />
            </div>
        </div>
    )
}
